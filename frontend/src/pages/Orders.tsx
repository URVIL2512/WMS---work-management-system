...
export default function Orders() {
  ...
  // Calculate order total
  // Removed calculateOrderTotal - orders should use snapshot values from quotation or stored values
  // No recalculation allowed per requirements
  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    try {
      ...
      if (formData.quotationId) {
        ...
        payload.packagingCost = formData.packagingCost || 0;
        payload.transportCost = formData.transportCost || 0;
        // Subtotal and gst are not in the formData type; fallback to totalAmount if missing
        payload.subtotal = formData.totalAmount || 0;
        payload.gst = 0; // If you need GST, calculate it from formData.gstPercent and totalAmount if applicable
        payload.finalTotal = formData.totalAmount || 0;
        payload.totalAmount = formData.totalAmount || 0;
        payload.paymentTerms = formData.paymentTerms || undefined;
      } else {
        // Legacy structure: single item with processes
            ...
            <div className="space-y-3 max-w-full">
              ...
              {selectedQuotationData && (
                <>
                  ...
                  {/* TOTAL SECTION - Use snapshot values from order/quotation (locked) */}
                  <div className="bg-gray-50 p-4 rounded-lg space-y-2">
                    <h3 className="text-lg font-bold text-gray-900 mb-3">Total Summary</h3>
                    <div className="grid grid-cols-2 gap-4">
                      <div>
                        <label className="block text-sm font-semibold text-gray-700 mb-1">Subtotal</label>
                        <input
                          type="text"
                          value={`₹${(selectedQuotationData.subtotal || selectedQuotationData.totalSubTotal || 0).toLocaleString('en-IN', { minimumFractionDigits: 2, maximumFractionDigits: 2 })}`}
                          readOnly
                          disabled
                          className="w-full px-4 py-2 border border-gray-300 rounded-lg bg-gray-100 text-gray-600 cursor-not-allowed"
                        />
                      ...
                      <div>
                        ...
                        <input
                          type="text"
                          value={`₹${(selectedQuotationData.gst || selectedQuotationData.totalTaxAmount || 0).toLocaleString('en-IN', { minimumFractionDigits: 2, maximumFractionDigits: 2 })}`}
                          readOnly
                          disabled
                          className="w-full px-4 py-2 border border-gray-300 rounded-lg bg-gray-100 text-gray-600 cursor-not-allowed"
                        />
                      ...
                      <div>
                        ...
                        <input
                          type="text"
                          value={`₹${(selectedQuotationData.packagingCost || 0).toLocaleString('en-IN', { minimumFractionDigits: 2, maximumFractionDigits: 2 })}`}
                          readOnly
                          disabled
                          className="w-full px-4 py-2 border border-gray-300 rounded-lg bg-gray-100 text-gray-600 cursor-not-allowed"
                        />
                      ...
                      <div>
                        <label className="block text-sm font-semibold text-gray-700 mb-1">Transport</label>
                        <input
                          type="text"
                          value={`₹${(selectedQuotationData.transportCost || 0).toLocaleString('en-IN', { minimumFractionDigits: 2, maximumFractionDigits: 2 })}`}
                          readOnly
                          disabled
                          className="w-full px-4 py-2 border border-gray-300 rounded-lg bg-gray-100 text-gray-600 cursor-not-allowed"
                        />
                      ...
                      <div className="col-span-2">
                        ...
                        <input
                          type="text"
                          value={`₹${(selectedQuotationData.finalTotal || selectedQuotationData.totalAmount || 0).toLocaleString('en-IN', { minimumFractionDigits: 2, maximumFractionDigits: 2 })}`}
                          readOnly
                          disabled
                          className="w-full px-4 py-2 border-2 border-green-500 rounded-lg bg-green-50 text-green-900 font-bold text-lg cursor-not-allowed"
                        />
              ...
              {!selectedQuotationData && (
                <>
                  ...
                  {/* TOTAL SUMMARY - Use stored values (no recalculation) */}
                  {/* <div className="bg-gray-50 p-4 rounded-lg space-y-2">
                  <h3 className="text-lg font-bold text-gray-900 mb-3">Total Summary</h3>
                  <div className="grid grid-cols-2 gap-4">
                    <div>
                      ...
                      <input
                        type="text"
                        value={`₹${(formData.totalSubTotal || 0).toLocaleString('en-IN', { minimumFractionDigits: 2, maximumFractionDigits: 2 })}`}
                        readOnly
                        disabled
                        className="w-full px-4 py-2 border border-gray-300 rounded-lg bg-gray-100 text-gray-600 cursor-not-allowed"
                      />
                    ...
                    <div>
                      <label className="block text-sm font-semibold text-gray-700 mb-1">GST ({formData.gstPercent || 0}%)</label>
                      <input
                        type="text"
                        value={`₹${(
                          typeof (formData as any).gstAmount === 'number'
                            ? (formData as any).gstAmount
                            : ((formData.totalSubTotal || 0) * (formData.gstPercent || 0) / 100)
                    ...
                    <div className="col-span-2">
                      ...
                      <input
                        type="text"
                        value={`₹${(formData.finalTotal || formData.totalAmount || 0).toLocaleString('en-IN', { minimumFractionDigits: 2, maximumFractionDigits: 2 })}`}
                        readOnly
                        disabled
                        className="w-full px-4 py-2 border-2 border-green-500 rounded-lg bg-green-50 text-green-900 font-bold text-lg cursor-not-allowed"
                      />
                  ...
                  <div className="bg-gray-50 p-4 rounded-lg space-y-2">
                    ...
                    <div className="grid grid-cols-2 gap-4">
                      ...
                      <div>
                        ...
                        <input
                          type="text"
                          value={`₹${(formData.subtotal || 0).toLocaleString('en-IN', { minimumFractionDigits: 2, maximumFractionDigits: 2 })}`}
                          readOnly
                          disabled
                          className="w-full px-4 py-2 border border-gray-300 rounded-lg bg-gray-100 text-gray-600 cursor-not-allowed"
                        />
                      ...
                      <div>
                        <label className="block text-sm font-semibold text-gray-700 mb-1">GST (18%)</label>
                        <input
                          type="text"
                          value={`₹${(((formData.totalAmount || 0) * 0.18)).toLocaleString('en-IN', { minimumFractionDigits: 2, maximumFractionDigits: 2 })}`}
                          readOnly
                          disabled
                          className="w-full px-4 py-2 border border-gray-300 rounded-lg bg-gray-100 text-gray-600 cursor-not-allowed"
                        />
                    ...
                    {loading && orders.length === 0 ? (
                      ...
                      orders.map((order: any) => (
                        <tr key={order._id} className="border-b border-gray-100 hover:bg-gray-50 transition-colors">
                          ...
                          <td className="py-3 px-4 text-sm text-gray-900 font-semibold">₹{order.totalAmount?.toLocaleString() || '0'}</td>
                          <td className="py-3 px-4">
                            <span className={`inline-block px-3 py-1 text-xs font-medium rounded-full ${order.status === 'Closed' ? 'bg-gray-100 text-gray-700' :
                                order.status === 'Delivered' ? 'bg-green-100 text-green-700' :
                                  order.status === 'Dispatched' ? 'bg-indigo-100 text-indigo-700' :
                                    order.status === 'Ready For Dispatch' ? 'bg-teal-100 text-teal-700' :
                                      order.status === 'In Production' ? 'bg-blue-100 text-blue-700' :
                          ...
                          <td className="py-3 px-4">
                            <div className="relative">
                              <button
                                ...
                                onClick={() => handleMenuToggle(order._id)}
                                data-menu-button
                                className={`p-2 rounded transition-colors ${openMenuId === order._id
                                    ? 'bg-gray-200 text-gray-800'
                                    : 'text-gray-600 hover:bg-gray-100'
                                  }`}
                                title="Actions"
          ...
          <div className="bg-white rounded-lg max-w-2xl w-full max-h-[90vh] overflow-y-auto">
            ...
            <div className="p-6 space-y-4">
              <div className="grid grid-cols-2 gap-4">
                ...
                <div>
                  <label className="block text-sm font-semibold text-gray-700 mb-1">Status</label>
                  <span className={`inline-block px-3 py-1 text-xs font-medium rounded-full ${selectedOrder.status === 'Closed' ? 'bg-green-100 text-green-700' :
                      selectedOrder.status === 'In Progress' ? 'bg-blue-100 text-blue-700' :
                        'bg-yellow-100 text-yellow-700'
                    }`}>
                    {selectedOrder.status}
